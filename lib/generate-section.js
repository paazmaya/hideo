    ...
    <section id="${key}">
      ...
      <div class="test-actions">
        ...
        <div class="test-action-accept">
          <button type="button" data-key="${key}" data-action="approve">Approve</button>
        </div>
      </div>
    </section>
  `;
